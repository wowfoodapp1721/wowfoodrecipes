...
(function (global) {
  ...
  function renderCuratedFeed(categoryKey, containerEl) {
    ...
    filteredRecipes.forEach(recipe => {
      ...
      const photoUrl = recipe.image || 'assets/sesame-chicken.png';
      const fallbackUrl = recipe.fallbackImage || 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=1200';
      ...
      card.innerHTML = `
        ...
        <div class="card-photo-container relative w-full">
          <div class="card-photo-wrap">
            <img class="card-photo" src="${photoUrl}" alt="${recipe.title}" loading="lazy" decoding="async" onerror="this.onerror=null; this.src='${fallbackUrl}'" />
          </div>
